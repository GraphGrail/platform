...
var mApp = function () {
    ...
    */
    ...
    return {
        ...
        */
        initScroller: function initScroller(el, options, doNotDestroy) {
        ...
        var Plugin = {
            ...
            init: function init(options) {
                ...
                $.each(Plugin.getOption('extensions'), function (extName, extOptions) {
                    if (typeof $.fn.mDatatable[extName] === 'function') new $.fn.mDatatable[extName](datatable, extOptions);
                });
            ...
            scrollbar: function scrollbar() {
                var scroll = {
                    ...
                    defaultScrollbar: function defaultScrollbar(scrollable) {
                    ...
                    mCustomScrollbar: function mCustomScrollbar(scrollable) {
            ...
            mCustomScrollbar: function mCustomScrollbar(element, options) {
            ...
            paging: function paging(meta, callback) {
                var pg = {
                    ...
                    updateInfo: function updateInfo() {
                        ...
                        // page info update
                        $(pg.pager).find('.m-datatable__pager-info').find('.m-datatable__pager-detail').html(Plugin.dataPlaceholder(Plugin.getOption('translate.toolbar.pagination.items.info'), {
                            start: start,
            ...
            replaceTableContent: function replaceTableContent(html, tablePart) {
                if (typeof tablePart === 'undefined') tablePart = datatable.tableBody;
            ...
            sort: function sort(field, _sort) {
                if (typeof _sort === 'undefined') _sort = 'asc';
            ...
            destroyScroller: function destroyScroller(element) {
...
jQuery.fn.extend({
    animateClass: function animateClass(animationName, callback) {
    ...
    animateDelay: function animateDelay(value) {
        var vendors = ['webkit-', 'moz-', 'ms-', 'o-', ''];
        for (var i = 0; i < vendors.length; i++) {
            jQuery(this).css(vendors[i] + 'animation-delay', value);
        }
    },
    animateDuration: function animateDuration(value) {
        var vendors = ['webkit-', 'moz-', 'ms-', 'o-', ''];
        for (var i = 0; i < vendors.length; i++) {
        ...
        var Plugin = {
            ...
            toggle: function toggle() {
                ...
                $(window).scroll(function () {
                    ...
                    if (mUtil.isInResponsiveRange('tablet-and-mobile') && header.options.classic && header.options.classic.mobile || mUtil.isInResponsiveRange('desktop') && header.options.classic && header.options.classic.desktop) {
                        if (st > offset) {
                            // down scroll mode
                            $("body").addClass(on);
    ...
    $.fn.mToggle = function (options) {
        ...
        var Plugin = {
            ...
            init: function init(options) {
                ...
                _toggle.state = mUtil.hasClasses(_toggle.target, _toggle.targetState) ? 'on' : 'off';
            },
            ...
            eventTrigger: function eventTrigger(name) {
                ...
                for (i = 0; i < _toggle.events.length; i++) {
